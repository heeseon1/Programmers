...
기존의 char[5][15] 배열 방식 ArrayList<String>로 변경하여 실행
  
사용자의 입력에 따라 문자열 길이의 최댓값을 동적으로 구할 수 있는 장점은 있으나,
  
메모리 사용량, 실행 시간 측면에서는 큰 차이가 없었음 (메모리: 14332 KB,	 시간: 104 ms)
